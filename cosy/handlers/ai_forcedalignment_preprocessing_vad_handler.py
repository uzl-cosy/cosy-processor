...
class AIForcedAlignmentPreprocessingVADHandler(Handler):
    """
    Handler class for the AI forced alignment preprocessing VAD tool.
    """
    ...
    def __init__(
        ...
        """
        Initialize the AIForcedAlignmentPreprocessingVADHandler object.
        ...
        logger.debug(
            "Initializing AIForcedAlignmentPreprocessingVADHandler"
            + " with base command "
